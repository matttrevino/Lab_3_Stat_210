...
```{r}
#| label: scatterplot
#this will create a scatterplot for weight by hindfoot length organized by species type. 
ggplot(surveys) +
  ...
  labs(x = "Weight",
       y = NULL,
       title = "Weight by Hindfoot Length for Species",
       subtitle = "Hindfoot Length") +
  #this will center the title and the subtitle text
       theme(
...
ggplot(data = surveys, aes(x = species, y = weight)) +
  ...
  geom_jitter(color = "springgreen4", alpha = 0.2, width = 0.2) +  
  labs(
